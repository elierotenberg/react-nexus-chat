...
var components = {
  ChatApp: _componentsChatApp2['default'] };
...
.get('/page/:componentName', function (req, res) {
  return Promise['try'](function () {
    ...
    var App = components[componentName];
    var nexus = App.createNexus({ req: req }, clientID, lifespan);
    return _reactNexus2['default'].prerenderApp(_react2['default'].createElement(App, props), nexus).then(function (_ref2) {
      ...
      lifespan.release();
      var _App$getRoutes$0 = App.getRoutes({ req: req })[0];
...
.get('/fragment/:componentName', function (req, res) {
  return Promise['try'](function () {
    ...
    var App = components[componentName];
    var nexus = App.createNexus({ req: req }, clientID, lifespan);
    return _reactNexus2['default'].prerenderApp(_react2['default'].createElement(App, props), nexus).then(function (_ref3) {
...
.get('/json/:componentName', function (req, res) {
  return Promise['try'](function () {
    ...
    var App = components[componentName];
    var nexus = App.createNexus({ req: req }, clientID, lifespan);
    return _reactNexus2['default'].prerenderApp(_react2['default'].createElement(App, props), nexus).then(function (_ref4) {
